...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.4\textwidth]{layoutfpga}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth]{synthese}
...
Dans le cadre de sa thèse, M. Alban Bourge a profité de l'utilisation des \emph{checkpoints} pour rendre possible
